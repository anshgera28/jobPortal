                    ...
                    </ul>
                    {
                        !user ? (
                            <div className="flex items-center gap-2">
                                <Link to="/login"><Button variant="outline" className="text-sm focus:outline-none focus:ring-0 focus:ring-offset-0 bg-[#007BFF] hover:bg-[#007BFF] text-white">Login</Button></Link>
                                <Link to="/signup"><Button className="text-sm focus:outline-none focus:ring-0 focus:ring-offset-0 bg-blue-500 text-white hover:bg-blue-600">Sign Up</Button></Link>
                            </div>
                        ) : (
                            <Popover>
